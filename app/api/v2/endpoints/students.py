...
from app.application.dto.student import StudentCreate, StudentUpdate, StudentSummary, StudentDetailed, StudentSummaryResponse, StudentDetailedResponse
...
async def list_students_basic(
    ...
    total, items = await service.get_students_summary()
    return StudentSummaryResponse(total=total, students=items)
...
async def list_students_detailed(
    ...
    total, items = await service.get_students_detailed()
    return StudentDetailedResponse(total=total, students=items)